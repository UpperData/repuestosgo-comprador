...
function CitySelect({ val = "", idsearch = null, error = null, id = 'item', onChange = () => console.log('change') }) {
    const placeholder = 'Seleccione una ciudad';
    const [options, setoptions] = useState([]);
    const [loadingdata, setloadingdata] = useState(true);

    const getData = () => {

        const urlGetCiudades   = `/citIes/VZlA/STAte/${idsearch}`;
